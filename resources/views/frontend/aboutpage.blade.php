            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about__image">
                        <img src="{{url($homeabout->about_image )}}" alt=""> <!--Here  we use url because the file is directly in the front end folder-->
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about__content">
                        ...
                        <p class="desc"><span>{{$homeabout->short_description}}</span></p>
                    ...
                    <div class="about__info__wrap">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="about-tab">
                                <p class="desc">{!!$homeabout->long_description!!}   <!--here we use this type with exclamatory because when these text area data is stored in database it will store with css elements to avoid that reflection on frontend we use it.-->
                                </p>
                            </div>
